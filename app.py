...
Original file is located at
    https://colab.research.google.com/drive/1OF6e4RoXCicX0PwIUGAN9IxwkA9JQDD2
"""
...
BD = pd.read_excel ("/content/drive/MyDrive/Pesquisas pessoais/Caxias/Dash/Caxias-Dash.xlsx")

"""### Com logo"""

!cp "/content/drive/MyDrive/Pesquisas pessoais/Caxias/Dash/CONSULTARE-Imagem.png" .

!cp "/content/drive/MyDrive/Pesquisas pessoais/Caxias/Dash/Disco_de_imagem-removebg-preview.png" .
...
# 
# 
# def grafico_barras(base, coluna, titulo, top_n=None):
#     tabela = (
#         base[coluna]
...
# with col3:
#     st.plotly_chart(
#         grafico_barras(dados, FE, "Distribuição por Faixa Etária"),
#         use_container_width=True
#     )
# 
# # ==============================
...
#         width=700
#     )
# #with st.expander("Visualizar base filtrada"):
# #    st.dataframe(dados)
# 
# # ==================================================
# # BASE FILTRADA
...
!cp "/content/drive/MyDrive/Pesquisas pessoais/Caxias/Dash/Caxias-Dash.xlsx" .
